...
import (
	...
	"github.com/GRANMOAL/Naturly/bd"
	"github.com/GRANMOAL/Naturly/handlers"
	"github.com/GRANMOAL/Naturly/models"
	"github.com/GRANMOAL/Naturly/secretmanager"
...
func EjecutoLambda(ctx context.Context, request events.APIGatewayProxyRequest) (*events.APIGatewayProxyResponse, error) {
	...
	path := strings.Replace(request.PathParameters["naturly"], os.Getenv("UrlPrefix"), "", -1)
